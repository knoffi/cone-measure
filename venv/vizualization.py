...
def gradNorm( params , cD ):
    return M.norm(cV.gradPhi( params , cD ))
...
polygon_test = [ [ 1 , 0 ] , [1,1] ,[ 0 , 1 ] , [ -1 , 0 ] , [ 0 , -1 ] ]#rP.getRandomPolygon(vertexNumber)
rP.makeCentered( polygon_test )
...
stepSize_plot = size_plot / 100.0
#vizConeDataParamFunction( size_plot , stepSize_plot , cV.phi , cD_test , midPoint_plot , a_plot , b_plot , c_plot )
#vizConeDataParamFunction( size_plot , stepSize_plot , gradNorm , cD_test , midPoint_plot , a_plot * 4 , b_plot * 4 , c_plot * 4 )
#vizConeDataParamFunction( size_plot * 4 , stepSize_plot * 4 , cV.phi , cD_test , [ 2 * size_plot , 2 * size_plot ] , a_plot , b_plot , c_plot )
#vizConeDataParamFunction( size_plot , stepSize_plot , cV.phi , cD_test , midPoint_plot , 10 * a_plot , 10 * b_plot , 10 * c_plot )
#vizConeDataParamFunction( size_plot , stepSize_plot , cV.phi , cD_test , midPoint_plot , 10 * a_plot , 10 * b_plot , 10 * c_plot )
vizConeDataParamFunction( size_plot , stepSize_plot , cV.sigma , cD_test , midPoint_plot , a_plot , b_plot , c_plot )
#vizConeDataParamFunction( 0.4 , 0.004 , cV.phi , cD_test , [ 0.5 , 1 ] , 0.01 , 0.1 , 1)
#vizConeDataParamFunction( 10 , 0.1 , pS.scalGradNormed , cD_test , [ 5, 5 ] , 0 , 0.5 , 0.8)
